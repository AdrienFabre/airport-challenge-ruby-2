describe 'User Stories' do 
  ...
  context 'when not stormy' do
    ...
    it 'flying planes cannot take off' do 
      expect { plane.take_off }.to raise_error 'Plane can not take off: plane already flying'
    end

    it 'fying planes cannot be in an airport' do 
      expect { plane.airport }.to raise_error 'Plane can not be in an airport: plane already flying'
    end
    ...
    it 'non-flying planes cannot land' do 
      airport.land(plane)
      expect { plane.land(airport) }.to raise_error 'Plane can not land: plane already landed'
    end
